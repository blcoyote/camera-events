...
class MinIOService:
    ...
    Handles bucket initialisation, uploading, downloading, and existence
    checks for event media objects (snapshots and clips).
    """
...
def get_minio_service() -> MinIOService:
    """Return a singleton :class:`MinIOService` instance."""
    return MinIOService()
