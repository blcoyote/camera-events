...
import { useGetApplicationConfigurationQuery } from "../services/camera-api.ts";
...
export const Component = () => {
	...
	const { data: config } = useGetApplicationConfigurationQuery();
	...
	return (
		<div className="bg-base-100 drop-shadow-xs p-5 mt-5 rounded-box">
			<div className="flex gap-5 flex-col justify-items-center">
				...
				{showNotifications && (
					<div className="flex flex-col gap-2">
						<h2>Notifications:</h2>
						<button type="button" className="btn btn-primary" onClick={toggleNotifications}>
